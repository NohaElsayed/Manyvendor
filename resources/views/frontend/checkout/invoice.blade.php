...
<html lang="en">
  <head>
    ...
    <title>{{ $name ? $name:'Guest Customer' }}</title>
  </head>
  <body>    
        ...
        <div class="card-body">
            <div class="row mb-4">
                ...
                <div class="col-sm-6">
                    ...
                    <div>
                        <strong>{{ $name ? $name:'Guest Customer' }}</strong>
                    </div>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="right">@translate(Shop)</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="left">
                                <img src="{{ filePath( $product->product->product->image ) }}" sizes="4vw" width="800" class="w-20">
                            </td>
                            <td class="left strong">{{ $product->name }}</td>
                            <td class="left">{{ $product->shop->shop_name ?? '' }}</td>
