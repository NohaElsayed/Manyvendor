            ...
            <div class="news">
                <figure class="article">
                    ...
                    <div class="card-body bg-light">
                        <h5>
                            Paytm payment gateway addon for Manyvendor eCommerce. Customer can checkout through Paytm. Install this addon for Paytm service. <br> Click on buy now and get this addon from codecanyon.
                        </h5>
