  ...
  <div class="row my-4">
    <div class="col-12">
       ...
       <form action="{{ route('addons.install.index') }}" method="POST" enctype="multipart/form-data">
            ...
            <input type="hidden" value="{{ $ssl_store_id }}" name="ssl_store_id" required>
            <input type="hidden" value="{{ $ssl_store_password }}" name="ssl_store_password" required>
       

        <div class="example">
        <input type="file" id="files1" class="no-w-h invisible" name="addons">
