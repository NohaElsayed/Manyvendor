...
@section('title') @translate(Main Sliders) @endsection
@section('content')

    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">@translate(Add New Main Slider)</h3>
        </div>
        <div class="card-body p-2 mx-2">
            <form action="{{ route('main.slider.promotion.store') }}" method="post" enctype="multipart/form-data">
                @csrf
    ...
    <div class="card card-primary card-outline">
        ...
        <div class="card-body p-2">
            <div class="row">
                @forelse (promotionBannersForBackend('mainSlider') as $slider)
                    <div class="col-md-10">
                        <div class="card card-primary card-outline">
                            ...
                            <ul class="dropdown-menu  dropdown-menu-right p-2" role="menu">
                                <li>
                                    <a href="#!" class="nav-link text-black"
                                       onclick="forModal('{{ route('main.slider.edit', $slider->id) }}', '@translate(Edit)')">@translate(Edit)</a>
                                </li>
                                <li class="divider"></li>
            ...
            {{ promotionBannersForBackend('mainSlider')->links() }}
