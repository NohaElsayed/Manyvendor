...
@section('title') @translate(Pop Up Promotions) @endsection
@section('content')

    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">@translate(Add New Pop Up Promotion)</h3>
        </div>
        ...
        <div class="card-body p-2">
            ...
            <div class="card-body">
                <form action="{{ route('popup.promotion.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">@translate(Pop Up Lists)</h3>
        </div>

        <!-- /.card-header -->
        <div class="card-body p-2">
            <div class="row">
                @forelse (promotionBannersForBackend('popup') as $slider)
                    <div class="col-md-10">
                        <div class="card card-primary card-outline">
                            ...
                            <ul class="dropdown-menu  dropdown-menu-right p-2" role="menu">
                                <li>
                                    <a href="#!" class="nav-link text-black"
                                       onclick="forModal('{{ route('popup.promotion.edit', $slider->id) }}', '@translate(Edit)')">@translate(Edit)</a>
                                </li>
                                <li class="divider"></li>
                ...
                @empty
                    <div class="ml-3 text-danger">
                        @translate(No Pop Up Found)
                    </div>
                @endforelse
            </div>
{{ promotionBannersForBackend('popup')->links() }}
        </div>
    </div>
