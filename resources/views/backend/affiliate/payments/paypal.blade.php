<div class="card">
	...
	<div class="card-body">
			...
			<div class="form-group">
				<label class="mb-0">@translate(Paypal Account Name)</label>
				<div class="form-control">{{$req->account->paypal_acc_name}}</div>
			</div>

			<div class="form-group">
				<label class="mb-0">@translate(Paypal Account Email)</label>
				<div class="form-control">{{$req->account->paypal_acc_email}}</div>
				@if(!$req->is_paid)<small class="text-primary">@translate(Please make the paypal payment in this account.)</small>@endif
			</div>
