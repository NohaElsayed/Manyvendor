<div class="card">
	...
	<div class="card-body">
			...
			<div class="form-group">
				<label class="mb-0">@translate(PayTm Number) <small class="text-danger">(@translate(Personal))</small></label>
				<div class="form-control">{{$req->account->payTm_number}}</div>


				@if(!$req->is_paid)<small class="text-primary">@translate(Please make the payTm payment in this number.)</small>@endif
			</div>
