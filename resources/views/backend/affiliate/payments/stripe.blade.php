<div class="card">
	...
	<div class="card-body">
			...
			<div class="form-group">
				<label class="mb-0">@translate(Stripe Account Name)</label>
				<div class="form-control">{{$req->account->stripe_acc_name}}</div>
			</div>

			<div class="form-group">
				<label class="mb-0">@translate(Stripe Account Email)</label>
				<div class="form-control">{{$req->account->stripe_acc_email}}</div>
				</div>

			<div class="form-group">
				<label class="mb-0">@translate(Stripe Card Holder Name)</label>
				<div class="form-control">{{$req->account->stripe_card_holder_name}}</div>
				</div>

			<div class="form-group">
				<label class="mb-0">@translate(Stripe Card Number)</label>
				<div class="form-control">{{$req->account->stripe_card_number}}</div>
				@if(!$req->is_paid)<small class="text-primary">@translate(Please make the stripe payment in this account.)</small>@endif
			</div>
