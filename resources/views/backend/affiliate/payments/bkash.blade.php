<div class="card">
	...
	<div class="card-body">
			...
			<div class="form-group">
				<label class="mb-0">@translate(Bkash Number) <small class="text-danger">(@translate(Personal))</small></label>
				<div class="form-control">{{$req->account->bKash_number}}</div>


				@if(!$req->is_paid)<small class="text-primary">@translate(Please make the bKash payment in this number.)</small>@endif
			</div>
