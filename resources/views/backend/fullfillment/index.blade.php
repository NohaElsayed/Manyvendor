...
@section('title') @translate(Fulfillment Management) @endsection
@section('css')
    ...
    <div class="card card-primary card-outline">
            ...
            <div class="text-center">
                @foreach ($logistics as $logistic)
                    <a class="btn btn-warning"
                       href="{{ route("fullfillment.logistic", $logistic->id) }}">{{ $logistic->name }}</a>
                @endforeach
            </div>
        </div>
                    ...
                    <form class="m-3" action="{{ route('find.order') }}" method="GET">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="input-group date" id="datetimepicker111" data-target-input="nearest">
                                            <input type="text" name="start_date" value="{{Request::get('start_date')}}"
                                                class="form-control datetimepicker-input" data-target="#datetimepicker111"
                                                placeholder="@translate(Order From)"/>
                                            <div class="input-group-append form-group" data-target="#datetimepicker111"
                                    ...
                                    <label>@translate(Order To)</label>
                                        <div class="input-group date" id="datetimepicker112" data-target-input="nearest">
                                            <input type="text" name="end_date" value="{{Request::get('end_date')}}"
                                                class="form-control datetimepicker-input" data-target="#datetimepicker112"
                                                placeholder="@translate(Order To)"/>
                                            <div class="input-group-append form-group" data-target="#datetimepicker112"
                                                data-toggle="datetimepicker">
                                                <div class="input-group-text form-group p-10"><i class="fa fa-calendar"></i>
                                                </div>
                                            </div>
                        ...
                        <div class="form-row mt-3">
                            ...
                            <div class="col">
                                ...
                                <input type="number" id="booking_code" name="booking_code" class="form-control"
        ...
        <div class="card-body p-2">
            ...
            <table class="table table-bordered">
                ...
                @forelse ($fullfillment_orders as $order)
                    <tr class="
                    ...
                    {{ $order->status === 'product_dispatched' ? 'bg-product_dispatched' : '' }}
                        ...
                        <td class="w-15">
                            ...
                            <span class="d-block">
                                        (Name) - {{ $order->product->product->name }} - {{ $order->vendor_product_stock->product_variants }}
                                    </span>
                            <span class="d-block">
...
@section('script')
    <script type="text/javascript">
        "use strict"
        $(function () {
            $('#datetimepicker111, #datetimepicker112').datetimepicker();
        });
    </script>
@endsection
