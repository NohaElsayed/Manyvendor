                ...
                <div class="card-body p-2">
                    <form action="{{route('users.update')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="">
                            ...
                            <div class="form-group row">
                                <label for="phn" class="col-md-4 col-form-label text-md-right">@translate(Phone number)</label>
                            ...
                            <div class="form-group row">
                                <label for="" class="col-md-4 col-form-label text-md-right">@translate(User Type)</label>

                                <div class="col-md-6">
                                    <input  type="text" readonly value="{{$user->user_type}}"
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-md-6">
                                    @foreach($user->groups as $item1)
                                        <span class="badge badge-primary">{{$item1->name}}</span>
                                    @endforeach
                                </div>
                            </div>
                        </div>
