<form action="{{route('currencies.update')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="name" class="col-form-label text-md-right">@translate(Name) <span
    ...
    <div class="form-group">
        <label for="name" class="col-form-label text-md-right">@translate(Symbol) <span
                class="text-danger">*</span></label>
    ...
    <div class="form-group">
        <label for="name" class="col-form-label text-md-right">@translate(Code) <span
                class="text-danger">*</span></label>
        <input placeholder="Ex : USD" type="text" class="form-control" value="{{$currency->code}}" name="code" required>
    </div>

    <div class="form-group">
        <label for="name" class="col-form-label text-md-right">@translate(Exchange Rate Ex: 1 USD = ? ) <span
                class="text-danger">*</span></label>
