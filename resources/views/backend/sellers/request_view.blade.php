  ...
  <div class="card card-primary card-outline">
      <div class="card-header">
          ...
          <div class="float-right">
              <a class="btn btn-success" href="{{ route("vendor.requests") }}">
                  @translate(Vendor Requests)
              </a>
          </div>
      </div>
      <!-- /.card-header -->
      <div class="card-body p-2">
          ...
          @endif
              ...
              <div class="">
                ...
                @if (!empty($single_request_vendor->shop_logo))
                    
                <div class="form-group text-center">
                      <div class="col-md-12">

                        <img src="{{ filePath($single_request_vendor->shop_logo) }}" class="img-fluid">

                          <input type="hidden" class="form-control" name="shop_logo" value="{{ $single_request_vendor->shop_logo}}" readonly>
              ...
              <div class="">
                  <div class="form-group row">
                      ...
                      <div class="col-md-6">
                          <input id="trade_licence" type="number" class="form-control @error('trade_licence') is-invalid @enderror" name="trade_licence" value="{{ $single_request_vendor->trade_licence}}" readonly>
              ...
              <div class="">
                  <div class="form-group row">
                      <label for="address" class="col-md-4 col-form-label text-md-right">@translate(Address)</label>
                      <div class="col-md-6">
                          <input id="address" type="text" class="form-control" name="address" value="{{ $single_request_vendor->address}}" readonly>
                      </div>
                  </div>
              </div>
