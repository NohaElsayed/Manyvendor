...
@section('title')
@endsection
<title>{{getSystemSetting('type_name')}} | @translate(Seller payment account)</title>
@section('parentPageTitle', 'Account Setup')
@section('content')
        ...
        <div class="col-md-10 offset-1">
            <div class="mx-2 mb-2">
                <div class="card-header">
                    <h2 class="card-title">@translate(Payment Account Setup)</h2>
                </div>
                <div class="">
