    ...
    public function toArray($request)
    {
       $bill = Customer::where('user_id',$this->user_id)->first();
        return [
            ...
            'orderProduct' => OrderProductResource::collection($this->order_product),
        ];
    }
}
...
class OrderProductResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'productName' => $this->product->product->name . Str::upper($this->vendor_product_stock->product_variants) ?? '',
            'productImage' => filePath($this->product->product->image)  ?? '',
