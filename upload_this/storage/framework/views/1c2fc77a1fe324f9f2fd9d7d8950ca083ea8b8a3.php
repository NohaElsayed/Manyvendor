...
<?php $__env->startSection('title'); ?> Delivered Orders <?php $__env->stopSection(); ?>
        ...
        <div class="card card-primary card-outline">
            <div class="card-body p-2 table-responsive">
                <table class="table table-bordered border" id="example">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $deliverOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getOrder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            ...
                            <td class="w-20">
                                    <span class="d-block">
                                        <?php if($getOrder->orderDetails->user): ?>
                                        Name - <?php echo e($getOrder->orderDetails->commentedBy ? $getOrder->orderDetails->user->name: 'Guest Order'); ?>
                            ...
                            <td class="w-15">
                                    <span class="d-block">
                                        <?php if(isset($getOrder->orderDetails->comment) || isset($getOrder->orderDetails->commentedBy)): ?>
                                            ...
                                            By <?php echo e($getOrder->orderDetails->deliverdBy->name ?? 'N/A'); ?>
                            ...
                            <td>
                                <?php echo e($getOrder->orderDetails->status); ?>
                ...
                <table class="table table-bordered border" id="example">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $deliverOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getOrder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            ...
                            <td class="w-20">
                                    <span class="d-block">
                                        Name - <?php echo e($getOrder->orderDetails->commentedBy ? ($getOrder->orderDetails->user == null ? 'Guest Order' : $getOrder->orderDetails->user->name): 'Guest Order'); ?>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\work\Installed\xampp\htdocs\codecanyon-mn\resources\views/backend/deliver/deliverdorder.blade.php ENDPATH**/ ?>