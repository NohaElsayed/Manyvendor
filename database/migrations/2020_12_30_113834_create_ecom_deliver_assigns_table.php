...
class CreateEcomDeliverAssignsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ecom_deliver_assigns', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ecom_deliver_assigns');
    }
}
