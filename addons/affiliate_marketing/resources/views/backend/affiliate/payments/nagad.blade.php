<div class="card">
	...
	<div class="card-body">
			...
			<div class="form-group">
				<label class="mb-0">@translate(Nagad Number) <small class="text-danger">(@translate(Personal))</small></label>
				<div class="form-control">{{$req->account->nagad_number}}</div>


				@if(!$req->is_paid)<small class="text-primary">@translate(Please make the nagad payment in this number.)</small>@endif
			</div>
