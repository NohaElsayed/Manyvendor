<div class="card">
	...
	<div class="card-body">
			...
			<div class="form-group">
				<label class="mb-0">@translate(Bank Name)</label>
				<div class="form-control">{{$req->account->bank_name}}</div>
			</div>

			<div class="form-group">
				<label class="mb-0">@translate(Account Name)</label>
				<div class="form-control">{{$req->account->account_name}}</div>
				</div>

			<div class="form-group">
				<label class="mb-0">@translate(Account Number)</label>
				<div class="form-control">{{$req->account->account_number}}</div>
				</div>

			<div class="form-group">
				<label class="mb-0">@translate(Routing Number)</label>
				<div class="form-control">{{$req->account->routing_number}}</div>
				@if(!$req->is_paid)<small class="text-primary">@translate(Please make the bank payment in this account.)</small>@endif
			</div>
